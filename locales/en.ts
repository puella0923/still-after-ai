...
const en: Translations = {
  ...
  onboarding: {
    ...
    empathyItems: [
      ...
      'They say time heals loss,\nbut some feelings only find their place once you let them out.',
    ],
    ...
    stage3Desc: 'When you\'re ready, share your final conversation.\nGently put in everything you wanted to say, and we\'ll help you send it.',
    stage3Hint: 'When you write and seal your final letter,\nthe conversation closes beautifully.\n\nGoodbye is not the end.',
  ...
  auth: {
    ...
    resendEmailSuccess: 'Verification email sent. Please check your inbox.',
    resendEmailFail: 'Failed to resend. Please try again.',
    emailAlreadyVerified: 'This email is already verified. Please log in.',
  ...
  personaCreate: {
    ...
    aiBanner: "We capture their tone and warmth, but don't replace the real person.",
    addPhoto: '📷 Add photo',
    ...
    submitBtn: 'Save memory',
    submitting: 'Creating memory...',
    errorEmptyFile: 'The file is empty.',
    errorCannotAnalyze: 'Unable to analyze the file.',
    kakaoErrTooFew: 'Not enough messages found. Please upload a file with more conversation.',
    kakaoErrGroup: "Group chats aren't supported. Please upload a 1:1 conversation file.",
    kakaoErrFormat: 'Invalid file format. Only .txt or .csv exported from KakaoTalk are supported.',
    ...
    validationPetMemory: 'Please enter at least 10 characters for the last memory',
    ...
    petQ1Label: 'What was their personality like?',
    petQ1Multi: '(multiple select)',
    petQ2Label: 'Did they have any special habits or quirks?',
    petQ2Optional: '(optional)',
    petQ3Label: 'How did they treat you?',
    petQ4Label: 'What did they love the most?',
    petQ5Label: 'Describe your last memory of them',
    petQ5Required: '*',
  ...
  home: {
    ...
    aiBanner: "Conversations here are responses based on memories. They don't replace the real person.",
    ...
    emptyDesc: 'Upload a KakaoTalk chat or write your memories\nto continue the conversation.',
    conversationCount: (n: number) => `${n} conversation${n !== 1 ? 's' : ''}`,
    loadError: 'Failed to load conversations. Tap to retry.',
    menuEdit: '✎ Edit',
    menuEditSub: 'Name · Relationship · Photo',
    menuDelete: '✕ Remove memory',
  ...
  chat: {
    ...
    closureNotReady: 'You haven\'t received the final farewell message yet. Please continue the conversation a little more.',
    ...
    archivedInputPlaceholder: 'This conversation has ended',
    stageHintToStable: 'The conversation style will shift slightly. You can ignore this and keep talking.',
    stageHintToClosure: "Press when you feel ready. There's no rush.",
    ...
    systemStableEntered: "🌙 You've entered the healing stage.\n\nIt's okay to share your own story now.\nLet your heart speak freely.",
    systemReturning: (name: string) => `💜 Your conversation with ${name} continues.\n\nThank you for coming back today.`,
    systemDeepening: (name: string) => `The conversation is deepening.\n\n${name} is listening to your story.`,
    ...
    crisisOk: "I'll come back later",
    dangerNotSent: 'Your message was not sent.',
    chatErrorMsg: "Couldn't get a response.",
    chatRetryBtn: 'Retry',
    saveError: '⚠️ Failed to save conversation',
    loadPersonaError: "We couldn't load this memory. Please try again in a moment.",
    retryLater: 'Please try again in a moment.',
    sendError: 'Failed to send message.',
    loginExpiredError: 'Your session expired. Please log in again.',
    dbHealthIssue: (_issue: string) => "We're having trouble saving the conversation. Please check your network connection.",
    greetingFallback: "I'll be with you in a moment. Feel free to say something first.",
  ...
  closure: {
    ...
    farewellGateMsg: (name: string) => `${name}'s last words are ready.\nAre you ready to read them?`,
    farewellGateBtn: "Yes, I'm ready",
    closureConfirmTitle: 'Are you ready?',
    closureConfirmDesc: 'Once sealed, new conversations will end,\nbut your shared stories and letter can always be read again.\n\nHave you put in everything you wanted to say?',
    closureConfirmBtn: "Yes, I'll send it gently",
    closureConfirmCancel: "I'll write a little more",
    closureDoneEmoji: '💜',
    closureDoneTitle: 'A beautiful farewell',
    closureDoneDesc: 'Your conversation and letter are always here when you need them.\nYou did beautifully.',
    closureDoneBtn: 'Back to home',
  },
  ...
  customerSupport: {
    ...
    heroSubtitle: "Check our FAQ first.\nIf that doesn't help, email us.",
    faqSection: 'FAQ',
    contactSection: 'Contact us',
    crisisBannerTitle: 'Are you struggling right now?',
    crisisBannerDesc: 'Korea Mental Health Crisis Line 1577-0199 (24hrs)',
    contactTitle: 'Email Support',
    contactHours: 'Mon–Fri 10AM–6PM KST\nWe reply within 1–2 business days.',
    emailBtnLabel: 'Send an email',
    emailErrorTitle: "Can't open email app",
    emailErrorMsg: 'Please email us directly at ysk@soomukstudio.com.',
    crisisTitle: 'Mental Health Crisis Line',
    crisisMsg: 'Connecting to 1577-0199.\nAvailable 24 hours.',
    crisisCancel: 'Cancel',
    crisisCall: 'Call now',
  },
